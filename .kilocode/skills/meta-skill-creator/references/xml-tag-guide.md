<overview>
Complete guide to XML tags and structure for Kilocode skills. Skills must use pure XML structure (no markdown headings) for consistent parsing and efficient token usage.
</overview>
