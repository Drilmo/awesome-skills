...
<core_principle>
Skills are specialized prompts that get loaded on-demand. All prompting best practices apply to skill creation, with emphasis on:
...
- State exactly what the AI should do
...
Help the AI avoid mistakes by showing bad vs good examples:
