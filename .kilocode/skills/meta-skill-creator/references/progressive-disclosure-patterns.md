...
The AI loads forms.md or api-reference.md only when needed.
</pattern>
...
When user asks about revenue, the AI reads only finance.md. Other files stay on filesystem consuming zero tokens.
</pattern>
...
**Why**: The AI may only partially read deeply nested files.
</one_level_deep>
...
```xml
See [~/.kilocode/skills/skill-name/references/patterns.md]
```
</reference_linking>
