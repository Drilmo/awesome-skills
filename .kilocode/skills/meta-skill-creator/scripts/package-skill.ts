 ...
 *
 * Examples:
 *   bun scripts/package-skill.ts ~/.kilocode/skills/my-skill
 *   bun scripts/package-skill.ts ~/.kilocode/skills/my-skill ./dist
 */
...
if (import.meta.main) {
  ...
  if (args.length < 1) {
    ...
    console.log("\nExamples:");
    console.log("  bun scripts/package-skill.ts ~/.kilocode/skills/my-skill");
    console.log("  bun scripts/package-skill.ts ~/.kilocode/skills/my-skill ./dist");
    process.exit(1);
  }
