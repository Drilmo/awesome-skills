...
```
Ready to push {branch_name} and create PR?

Options:
- Push and create PR (Recommended): Push commits to remote and open pull request
- Push only: Push to remote without creating PR
- Review commits first: Show me the full diff before pushing
- Cancel: Don't push or create PR
```
