...
```
You're on {current_branch}. Create a new branch for this task?

Options:
- Create feat/{task_id} (Recommended): Create new feature branch and switch to it
- Custom branch name: I'll specify a custom branch name
- Stay on {current_branch}: Continue without creating a branch (not recommended for PRs)
```
