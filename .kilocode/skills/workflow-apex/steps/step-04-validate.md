...
Options:
- Run adversarial review: Deep review for security, logic, and quality
- Complete workflow: Skip review and finalize
- Add tests: Create additional tests first
```
...
❌ **CRITICAL**: Not using `ask_followup_question` for next step
